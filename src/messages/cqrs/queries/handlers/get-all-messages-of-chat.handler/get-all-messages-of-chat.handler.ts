...
export class GetAllMessagesOfChatHandler implements IQueryHandler<GetAllMessagesOfChatQuery> {
    constructor(@InjectRepository(MessageModel) private messageRepository: Repository<MessageModel>,){}
